    ...
    subCategories: [
      {
        id: "Portrait",
        label: "Portrait",
        route: "/photo-gallery?category=nilgiri-tahr&sub=Portrait",
        icon: <Camera {...ICON_SUB} />,
      },
      {
        id: "Landscape",
        label: "Landscape",
        route: "/photo-gallery?category=nilgiri-tahr&sub=Landscape",
        icon: <Mountain {...ICON_SUB} />,
      },
      {
        id: "Mountain",
        label: "Mountain",
        route: "/photo-gallery?category=nilgiri-tahr&sub=Mountain",
        icon: <Mountain {...ICON_SUB} />,
      },
      {
        id: "Herd",
        label: "Herd",
        route: "/photo-gallery?category=nilgiri-tahr&sub=Herd",
        icon: <PawPrint {...ICON_SUB} />,
      },
      {
        id: "Radio-Collaring",
        label: "Radio Collaring",
        route: "/photo-gallery?category=nilgiri-tahr&sub=Radio-Collaring",
        icon: <Compass {...ICON_SUB} />,
      },
      {
        id: "Love",
        label: "Love",
        route: "/photo-gallery?category=nilgiri-tahr&sub=Love",
        icon: <Heart {...ICON_SUB} />,
      },
    ],
  },
