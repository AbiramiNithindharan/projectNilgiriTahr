...
const NationalParksClient = () => {
  return (
    <div className={styles.container}>
      ...
      >
        <motion.img
          src="/gallery/national-parks.jpg"
          alt="Nilgiri Tahr"
      ...
      >
        ...
        >
          ...
          >
            A unique high-altitude ecosystem in the Anamalai Hills, dominated by
            montane grasslands that form prime Nilgiri Tahr grazing areas.
          </motion.p>
          <motion.h3
            initial={{ y: 30, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
...
export default NationalParksClient;
