...
import styles from "./annual-reports.module.css";
  ...
  const reports = [
    {
      ...
      subtitle: "Highlights of our performance, growth, and community impact.",
      link: "#",
    },
    {
      id: 2,
      ...
      subtitle: "Showcasing innovation and sustainability achievements.",
      link: "#",
    },
    {
      id: 3,
      ...
      subtitle: "A look back at milestones that shaped our organization.",
      link: "#",
    },
    {
      id: 4,
      ...
      subtitle: "Steady growth despite challenges — resilience in focus.",
      link: "#",
    },
  ];
      ...
      >
        ...
        >
          <div className={styles.swiperContainer}>
            <h2 className={styles.sectionTitle}>Our Annual Reports</h2>
            <Swiper
